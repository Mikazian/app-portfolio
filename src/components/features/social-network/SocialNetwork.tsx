...
const SocialNetwork = (): React.JSX.Element => {
  ...
  return (
    <section className="flex flex-row justify-end items-center gap-4 lg:flex-col lg:fixed lg:bottom-0 lg:right-0 lg:mb-5 lg:mr-7 lg:w-[25px] relative z-20">
      <Text className="font-title-bold translate-y-0.5 lg:absolute lg:origin-left lg:rotate-90 lg:top-0 lg:left-0 uppercase text-sm lg:mb-6 lg:translate-x-3 lg:-translate-y-24 text-nowrap">
        Me suivre
      </Text>

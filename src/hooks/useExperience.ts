...
export const useExperience = () => {
  ...
  const userExperiences: ExperienceType[] = sortedExperiences.map((experience) => {
    const duration = calculateDurationInMonth(experience.start_date, experience.end_date);
